    ...
    var Engine = function () {
        function Engine(loaderRes) {
            ...
            Backbone.on(Events.Backbone.All.AllRendered, function (stage) {
                ...
                $(this.container.playersContainerBoss).trigger(Events.Game.AbstractCardContainerModel.CreateGraphics, [SETTINGS.battleContainerPositionX - 10, SETTINGS.oneLineHeight, false]);
                ...
                this.container.playersContainerBossCard.trigger(Events.Game.AbstractCardContainerModel.SetContainerPosition, this.container.playersContainerBoss.containerView.containerView, 0, 0);
                $(this.container.playersContainerBossCard).trigger(Events.Game.AbstractCardContainerModel.CreateGraphics, [SETTINGS.cardWidth, SETTINGS.oneLineHeight]);

                this.container.enemyContainerBoss.trigger(Events.Game.AbstractCardContainerModel.SetContainerPosition, stage, 10, 0);
                $(this.container.enemyContainerBoss).trigger(Events.Game.AbstractCardContainerModel.CreateGraphics, [SETTINGS.battleContainerPositionX - 10, SETTINGS.oneLineHeight, false]);
                ...
                this.container.enemyContainerBossCard.trigger(Events.Game.AbstractCardContainerModel.SetContainerPosition, this.container.enemyContainerBoss.containerView.containerView, 0, 0);
                $(this.container.enemyContainerBossCard).trigger(Events.Game.AbstractCardContainerModel.CreateGraphics, [SETTINGS.cardWidth, SETTINGS.oneLineHeight]);

                this.container.playersInfoCardContainer.trigger(Events.Game.AbstractCardContainerModel.SetContainerPosition, stage, SETTINGS.infoCardContainerPositionX, 2 * SETTINGS.oneLineHeight);

                this.container.playersBattleInfoCardContainer.trigger(Events.Game.AbstractCardContainerModel.SetContainerPosition, stage, SETTINGS.infoBattleCardContainerPositionX, SETTINGS.infoBattleCardContainerPositionY);
